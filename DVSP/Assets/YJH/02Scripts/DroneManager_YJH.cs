...
public class DroneManager_YJH : RobotConnector2
{
    ...
    void Update()
    {
        ...
        print("L"+pedL.x.ToString()+ ":" + pedL.y.ToString()) ;
        print("R"+pedR.x.ToString()+ ":" + pedR.y.ToString()) ;
        ...
        if (_opened == true)
        {
            ...
            else if (OVRInput.Get(OVRInput.Button.One, OVRInput.Controller.LTouch))    // take Off
            {
                takeoffPressed++;
            }
