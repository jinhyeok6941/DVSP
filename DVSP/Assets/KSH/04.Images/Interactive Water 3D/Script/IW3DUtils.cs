...
namespace InteractiveWater3D
{
	...
	{
		static public Mesh CreateGridPlaneMesh (int grid, float w, float h, Vector3 offset)
		{
		...
		static public Camera CreateOrthographicCamera (Transform parent, LayerMask lm, Shader sdr, float camSize)
		{
