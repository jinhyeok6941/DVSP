...
Setup Guides:
  ...
  => In demo scene, I use layer name "Water" as the layer mask for water surface.  You can also change to your own layer name.
  => The demo scene demonstrate all features, please refer to it for a usage example.

If you like it, please give us good review on asset store. We will keep moving !
